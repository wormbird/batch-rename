...
path_entry = ttk.Entry(window, textvariable=path_var, font=('微软雅黑', 14))
...
name_entry = ttk.Entry(window, textvariable=name_var, font=('微软雅黑', 14))
name_entry.pack(ipadx=80)


def begin_handle():
    messages,num = batch_rename(path_var.get(),name_var.get())
    messagebox.showinfo('提示',"修改%d个文件名称"%(num,))
